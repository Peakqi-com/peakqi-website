...
export const POSTS = [
  {"slug":"ai-crm-vs-traditional-crm","date":"2026-09-25","tags":["ai-adoption","customer-ops"],"hasEn":true,"zh":{"title":"AI CRM 跟傳統 CRM 差在哪?一張表看懂,再決定要不要換","summary":"傳統 CRM 等你填;AI CRM 把對話變成客戶卡、把下一步排出來。一張比較表,加上什麼情況傳統 CRM 其實就夠。","mins":7},"en":{"title":"AI CRM vs traditional CRM: the real difference, in one table","summary":"A traditional CRM stores what you type; an AI CRM turns conversations into records and schedules the next step. One table, plus when the old CRM is enough.","mins":7}},
  {"slug":"ai-automation-cost-and-timeline","date":"2026-09-02","tags":["ai-adoption","automation"],"hasEn":true,"zh":{"title":"中小企業導入 AI 自動化要多少錢、多久上線?費用結構完整拆解","summary":"不給一個假裝精確的總價,而是把導入費、月費、使用量費三塊拆開,說明每一塊由什麼決定、時程怎麼估,以及哪些情況會變貴。","mins":4},"en":{"title":"What AI automation costs a small business, and how long it takes to launch","summary":"Setup fee, monthly fee and usage cost, broken apart: what drives each one, how to estimate the timeline, and what makes a project more expensive.","mins":4}},
  {"slug":"how-to-choose-ai-automation-partner","date":"2026-09-02","tags":["ai-adoption","automation"],"hasEn":true,"zh":{"title":"台灣中小企業 AI 自動化公司怎麼選:六個問題先問清楚","summary":"選 AI 自動化廠商,重點不是功能清單,而是流程、資料、人工審核與退場條件。這篇整理六個簽約前該問的問題與一張比較表。","mins":4},"en":{"title":"How to choose an AI automation partner in Taiwan: six questions to ask first","summary":"Choosing an AI automation vendor isn't about the feature list — it's process, data, human review and exit terms. Six questions to ask before signing.","mins":5}},
  {"slug":"line-ai-support-crm-integration","date":"2026-09-02","tags":["automation","customer-ops"],"hasEn":true,"zh":{"title":"LINE AI 客服怎麼串接 CRM?從接住詢問到自動建檔的完整流程","summary":"LINE 官方帳號接上 AI 只解決一半問題——回完的對話沒有進 CRM,追客還是靠人腦。這篇拆解串接的四個環節、常見斷點與導入步驟。","mins":4},"en":{"title":"Connecting LINE AI support to your CRM: from first enquiry to an automatic record","summary":"AI on a LINE Official Account solves half the problem: if the chat never reaches your CRM, follow-up still runs on memory. Four links, four breaks.","mins":5}},
