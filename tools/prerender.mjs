...
const PAGES = [
  ...
  ['AIMarketingPro', '/ai-marketing-pro', 'AI Marketing Pro', 'AI Marketing Pro'],
  ['ZhangguiAI', '/zhanggui-ai', '掌櫃 AI', 'Zhanggui AI'],
  ['AllInStudio', '/all-in-studio', '活動玩很大', 'All In Studio'],
