...
export function createHomeEngine() {
  ...
  async function mountCinema() {
    ...
    const CINEMA_SCENES = [
      { id: 'hero',            group: 'intro',       legacy: [0.000, 0.040], desktopVh: 165, touchVh: 95 },
      { id: 'lens',            group: 'camera-part', legacy: [0.040, 0.080], desktopVh: 140, touchVh: 80 },
      { id: 'mainboard',       group: 'camera-part', legacy: [0.080, 0.120], desktopVh: 140, touchVh: 80 },
      { id: 'sensor',          group: 'camera-part', legacy: [0.120, 0.160], desktopVh: 140, touchVh: 80 },
      { id: 'shutter',         group: 'camera-part', legacy: [0.160, 0.200], desktopVh: 140, touchVh: 80 },
      { id: 'chassis-rainbow', group: 'camera-part', legacy: [0.200, 0.240], desktopVh: 300, touchVh: 170 },
      { id: 'blueprint-intro', group: 'white',       legacy: [0.240, 0.290], desktopVh: 180, touchVh: 105 },
      { id: 'study-01',        group: 'white-part',  legacy: [0.290, 0.332], desktopVh: 135, touchVh: 80 },
      { id: 'study-02',        group: 'white-part',  legacy: [0.332, 0.374], desktopVh: 135, touchVh: 80 },
      { id: 'study-03',        group: 'white-part',  legacy: [0.374, 0.416], desktopVh: 135, touchVh: 80 },
      { id: 'study-04',        group: 'white-part',  legacy: [0.416, 0.458], desktopVh: 135, touchVh: 80 },
      { id: 'study-05',        group: 'white-part',  legacy: [0.458, 0.500], desktopVh: 135, touchVh: 80 },
      { id: 'reassembly',      group: 'white',       legacy: [0.500, 0.578], desktopVh: 250, touchVh: 145 },
      { id: 'summary',         group: 'transition',  legacy: [0.578, 0.700], desktopVh: 160, touchVh: 90 },
      { id: 'video-01',        group: 'video',       legacy: [0.700, 0.744], desktopVh: 135, touchVh: 80 },
      { id: 'video-02',        group: 'video',       legacy: [0.744, 0.788], desktopVh: 135, touchVh: 80 },
      { id: 'video-03',        group: 'video',       legacy: [0.788, 0.832], desktopVh: 135, touchVh: 80 },
      { id: 'video-04',        group: 'video',       legacy: [0.832, 0.876], desktopVh: 135, touchVh: 80 },
      { id: 'video-05',        group: 'video',       legacy: [0.876, 0.920], desktopVh: 162, touchVh: 95 },
      { id: 'cta',             group: 'outro',       legacy: [0.920, 1.000], desktopVh: 145, touchVh: 85 }
    ];
