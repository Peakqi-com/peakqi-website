...
- `allen-sky.js` — 天色:白天 / 黃昏 / 夜晚。開場看訪客自己的時鐘(6–16 白天、17–19 黃昏、
  ...
  **關燈的影響範圍會跟著時段收**:白天與黃昏只有燈下那一小圈(離燈頭 180px 之外
  完全為零,房間的亮度變化在 ±0.3 階以內)—— 房間亮的時候關掉一盞桌燈,不會讓整個房間暗一階,
  那看起來不是關燈,是憑空多出一團黑色光暈。夜裡才拿掉上限,因為它真的是主光。

  重量:白天 + 開燈是原圖本身,**零額外請求**;黃昏 37KB、夜晚 48KB、三張關燈圖共 33KB,
