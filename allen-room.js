...
const STARS = 34;
// 月亮慢慢升。整段行程都要看得見整顆月亮,所以兩端都不是隨便取的:
//   lo 416 = 天際線頂端 442(量自 city-mask 的 x=196 那一欄)+ 半徑 26。
//            原本 585 在天際線後面,整整 35% 的行程(約 91 秒)看不到或只看到一半。
//   hi 186 = 圓心再高就會被窗框切掉(量自 sky-mask:圓完全落在天空內的最高圓心是 179,
//            留 7px 餘裕)。原本 96 太高,升到頂反而不見了。
const MOON = { r: 26, x: 196, lo: 416, hi: 186, per: 260 };
